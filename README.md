...
|[Gilded Rose Refactoring](https://github.com/Thatguy560/GildedRose-Refactoring-Kata) <img width="1000" alt="" src="./Assets/rose-1-pcs-Golden-rose-24K-gilded-rose-valentine-Gold-rose-Artificial-flowers-wedding-decoration-gift.jpg_640x640.png" height="130" width="160"> | Another Tech test that involved cloning a repository, reading it and refactoring the legacy code. I used the gem 'Simplecov' for test coverage (100.00% Achieved).  | Ruby, RSpec                 
