...
| ------------- | -----------------------------------| ------------- |
| <img width=“1600” alt=“” src=./Assets/bank_PNG24.png” height=“130” width=“258”> [Bank Tech Test](https://github.com/Thatguy560/Banktechtest)  | A Tech Test built over a 3 day period, using irb you can make deposits, withdrawals, check the balance of your account and print a statement. I used the gem 'Simplecov' for test coverage (100.00% Achieved).                | Ruby, RSpec |
