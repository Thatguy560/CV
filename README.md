...
<h3 align="center">[Online Portfolio](https://thatguy560.github.io/)<h3>
...
|<p align="center">[IsItBusyOrNot](https://github.com/Peter2-71828/IsItBusyOrNot)</p><img width="1000" alt="" src="./Assets/Screenshot 2020-06-04 at 19.48.56.png" height="130" width="160"> | In order to make social distancing more manageable, we created an App which allows a user to search for a location and see how busy it is. A Hackathon team project on the brief of COVID-19, made in 2 and a half days. Feel free to try it out yourself here https://is-it-busy-or-not.herokuapp.com/  | <p align="center">React, Express.js, Twitter API, OpenLayers API, Heroku</p>             
