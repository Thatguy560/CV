...
|[Gilded Rose Refactoring](https://github.com/Thatguy560/GildedRose-Refactoring-Kata) | Another Tech test that involved cloning a repository, reading it and refactoring the legacy code. I used the gem 'Simplecov' for test coverage (99.16%).  | Ruby, RSpec                 
